...
public class DataPath {
	...
	// 관리자
	public final static String amdin = "C:\\class\\java\\CafePosSystem\\data\\admin.txt";
	
	// 회원정보
	public final static String userdata = "C:\\class\\java\\CafePosSystem\\data\\userdata.txt";
